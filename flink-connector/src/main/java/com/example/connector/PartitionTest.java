...
public class PartitionTest {
    ...
    private static String CREATE_ORDER_SQL = "\n" +
            ...
            // "  'properties.flink.partition-discovery.interval-millis' = '10000',\n" +
    ...
    private static String SINK_ORDER = "CREATE TABLE `order_rate` (\n" +
            "    order_id    STRING,\n" +
            "    price       DECIMAL(32,2),\n" +
            "    currency    STRING,\n" +
            "    order_time  BIGINT \n" +
    ...
    public static void main(String[] args) {
        ...
        Table table = tEnv.sqlQuery("SELECT *, now() FROM orders");
